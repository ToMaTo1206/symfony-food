 ...
 */
final class Version20260202224600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE food (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, quantity INT NOT NULL, expiry_date DATE NOT NULL, weight INT DEFAULT NULL, user_id INT NOT NULL, INDEX IDX_D43829F7A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
